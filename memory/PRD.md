...
- V2 horizontale (20/08/2026, demande utilisateur) : remplacée par un DÉFILEMENT HORIZONTAL piloté par le scroll vertical — piste flex w-max translatée par interpolation exacte des centres de cartes mesurés au DOM (offsetLeft + width/2, re-mesuré au resize), spring 90/26 ; le livre centré s'agrandit (scale 1, net) pendant que les voisins s'estompent (0.82, opacité 0.35, blur) ; titre+sous-titre apparaissent sous le livre actif uniquement ; vérifié : track x −33→−1044px, livre 5 centré à 960px exact
- V3 carrousel swipe (20/08/2026, demande utilisateur « pas au scroll mais en swipant ») : plus de scroll-jacking — section normale py-28 avec carrousel draggable (framer-motion drag="x", constraints calculés sur les centres de cartes, elastic 0.12, snap par vitesse projetée au relâchement, spring 260/32) ; flèches prev/next + points cliquables ; indice « ← Glissez pour explorer → » ; vérifié : swipe gauche → L'Esprit de l'Âme centré, clic flèche → Les Intrigues du Diable, compteur 03/05
- V3.1 fix glisse libre (20/08/2026, « ça swippe tout seul ») : dragMomentum=false + suppression de la projection de vélocité + spring adouci (220/30) + elastic 0.08 — le carrousel suit le doigt au pixel et ne bouge plus après le relâchement ; vérifié : petit swipe = retour au même livre, x identique à 1.5s d'écart (aucune dérive), grand swipe = exactement 1 livre plus loin
- V3.2 auto-play (20/08/2026, « non ça doit être animé ! » — le message précédent VOULAIT l'auto-avance + swipe) : intervalle 3,2s qui avance au livre suivant en boucle (rewind au 1er après le 5e), en PAUSE pendant le drag et au survol ; swipe manuel conservé intact ; vérifié : t0 Esprit de l'Âme → +4s Intrigues du Diable → +7s Ainsi était Muhammad (auto), swipe manuel → Nos Pieux Prédécesseurs
- V3.3 coverflow (20/08/2026, « pas un défilement classique ») : voisins clairement visibles de part et d'autre du livre central — offset ±1 : scale 0.74, opacité 0.55, rotateY ±32° (perspective 1400px sur le conteneur) ; offset ±2 : scale 0.6, opacité 0.28 ; gaps resserrés (6/10) ; le livre arrivant au centre grossit et son titre apparaît ; vérifié en captures (coverflow net, auto-avance + next OK)
- V3.4 correction coverflow (20/08/2026, « pas bon ni sur mobile ») : rotation 3D et blur retirés (l'utilisateur voulait simplement plus petit + moindre opacité) ; cartes resserrées (46vw mobile / 320px desktop) pour que les voisines restent visibles sur téléphone ; titre du livre actif apparaît avec 0.25s de délai (après centrage) ; vérifié stable : mobile centré 195/195, desktop centré 960/960, voisines visibles des deux côtés sur les deux
