...
const inputClass =
  "w-full bg-transparent border border-white/15 focus:border-[#D4AF37] outline-none px-5 py-4 text-sm font-light text-[#F2EBE5] placeholder:text-[#A39E93]/50 transition-colors duration-300";
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        <ChapterHeading number="05" title="La Commande" />
        <div className="grid lg:grid-cols-12 gap-16">
          <div className="lg:col-span-5">
            ...
            <Reveal delay={0.1}>
              <p className="mt-8 text-base sm:text-lg font-light leading-relaxed text-[#A39E93]">
                ...
                heures pour finaliser la commande. Pas de paiement en ligne —
                un échange, comme autrefois.
              </p>
            </Reveal>
            <Reveal delay={0.2}>
              <div className="mt-12 border border-white/10 bg-[#13151A] p-7" data-testid="order-summary">
                ...
                <div className="mt-5 flex items-baseline justify-between border-b border-white/10 pb-4">
                  <p className="font-display text-xl text-[#F2EBE5]">
                    {author.book.titleLatin} — {author.book.titleFrench}
                  </p>
                  <p className="font-display text-xl text-[#D4AF37]">{author.book.price}</p>
                </div>
                <p className="mt-4 font-mono-archive text-[10px] tracking-[0.2em] uppercase text-[#A39E93]">
                  {author.book.publisher} · reliure rigide · français
                </p>
              </div>
            </Reveal>
          </div>
          ...
          <div className="lg:col-span-7">
            <Reveal delay={0.15}>
              {receipt ? (
                <div
                  className="border border-[#D4AF37]/40 bg-[#13151A] p-10 sm:p-14"
                ...
                >
                  ...
                  <p className="mt-4 text-base font-light leading-relaxed text-[#A39E93]">
                    Reçu Nº <span className="font-mono-archive text-[#D4AF37]">{receipt.slice(-6).toUpperCase()}</span> —
                ...
                <form onSubmit={submit} className="space-y-6" data-testid="order-form">
